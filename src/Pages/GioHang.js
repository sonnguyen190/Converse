  ...
  render() {
    return (
      <div className="grid wide">
        <h5 className="shoppingCart_h5">Shopping Cart</h5>
            ...
            {this.state.tong === 0 ? (
              ...
              <>
                ...
                <div className="right_cart">
                  ...
                  <div
                    className={`content_sumary_cart ${
                      this.state.scrollY === true ? "active" : ""
                    }`}
                  >
                    <div>
                      <div className="title_subtotal">Subtotal</div>

                      <b className="subtotal">${this.props.tong_tien}.00</b>
                    </div>
                    <hr />
                    <div>
                      <div className="title_subtotal">Tax</div>

                      <b className="subtotal">$0.00</b>
                    </div>
                    <hr />
                    <div>
                      <div className="title_subtotal">Order Total</div>

                      <b className="subtotal">${this.props.tong_tien}.00</b>
                    </div>
                    <div className="price_cart">
                      <Link to={"/Checkout"} className="button_buy_cart">
                        <div className="button_buy_cart"> Checkout</div>
                      </Link>
                    </div>
                    <div className="price_cart">
                      <div className="paypal_all">
                        <img
                          className="paypal"
